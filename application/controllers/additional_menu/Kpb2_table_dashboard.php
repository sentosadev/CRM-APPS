...
class Kpb2_table_dashboard extends Crm_Controller
{
  var $title  = "Tabel & Tampilan Dashboard KPB 2";
  var $db2 = '';
  ...
  public function fetchData()
  {
    ...
    foreach ($fetch_data as $rs) {
      ...
      $sub_array[] = $rs->ssu;
      $sub_array[] = $rs->kpb2_return;
      $sub_array[] = number_format(@($rs->kpb2_return / $rs->ssu) * 100, 2);
      $data[]      = $sub_array;
      $no++;
    }
    $output = array(
