...
class Migration_Create_status_fu extends CI_Migration

{
...

    {
        $this->dbforge->add_field(array(
            ...
            'deskripsi_status_fu' => ['type' => 'VARCHAR', 'constraint' => '100'],
        ...
        $this->dbforge->create_table('ms_status_fu', FALSE, $attributes);
    }
    ...
    {
        $this->dbforge->drop_table('ms_status_fu');
    }
}
