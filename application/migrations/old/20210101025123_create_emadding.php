...
class Migration_Create_emadding extends CI_Migration

{
...

    {
        ...
        $this->dbforge->add_field(array(
            'id_emadding' => ['type' => 'INT', 'constraint' => 10, 'auto_increment' => true],
        ...
        $this->dbforge->add_key('id_emadding', TRUE);
        $attributes = array('ENGINE' => 'InnoDB');
        $this->dbforge->create_table('emadding', FALSE, $attributes);
    }
    ...
    {
        $this->dbforge->drop_table('emadding');
    }
}
