...

{
...

    {
        $this->dbforge->add_field(array(
            'leads_id_int' => ['type' => 'BIGINT', 'constraint' => 20, 'unsigned' => true, 'auto_increment' => true],
        ...
        $this->dbforge->add_key('leads_id_int', TRUE);
        $this->dbforge->create_table('leads', FALSE, $attributes);
    }
