...

{
    ...
    {
        $this->db->trans_begin();
        $this->db->query("ALTER TABLE `staging_table_leads` DROP INDEX `noTelp`, ADD INDEX `noTelp` (`noTelp`) USING BTREE;");
        $this->db->query("ALTER TABLE `staging_table_leads` DROP INDEX `noHP`, ADD INDEX `noHP` (`noHP`) USING BTREE;");
        $this->db->query("ALTER TABLE `staging_table_leads` DROP INDEX `email`, ADD INDEX `email` (`noHP`) USING BTREE;");

        $this->dbforge->drop_table('staging_table_leads_interaksi');
