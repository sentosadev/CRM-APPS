        ...
        <div class="form-horizontal">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <?php $this->load->view('manage_customer/leads_customer_data/detail_tab_data_registrasi', $dt); ?>
              <?php $this->load->view('manage_customer/leads_customer_data/detail_tab_pengajuan_kontak_sales', $dt); ?>
              <?php $this->load->view('manage_customer/leads_customer_data/detail_tab_data_pendukung_probing_1', $dt); ?>
              <?php
              $dt['tot_tab_fol'] = $tot_tab_fol;
              $this->load->view('manage_customer/leads_customer_data/detail_tab_data_follow_up', $dt); ?>
            </div>
            <!-- /.tab-content -->
          </div>
        </div>
