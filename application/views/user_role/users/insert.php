  <section class="content">
        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
                ...
                <div class="col-sm-4">
                  <select class="form-control select2" style="width: 100%;" name='id_group'>
                    ...
                    <?php foreach ($user_groups as $ug) { ?>
                      <option value='<?= $ug->id_group ?>'><?= $ug->nama_group ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select class="form-control" style="width: 100%;" name='main_dealer_or_dealer' id="main_dealer_or_dealer" onchange="cekMainDealerOrDealer()">
                    <option value=''>- Pilih -</option>
              ...
              <div class="form-input" id="input_kode_dealer">
                <div class="col-sm-4">
                  <select style='width:100%' id="kode_dealer" class='form-control' name='kode_dealer'>
                    <option value=''>- Pilih -</option>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="password" class="form-control" name='password' id='password' required onkeyup="handleKeyUp()">
            ...
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='no_hp' required onkeypress="only_number(event)">
                </div>
              </div>
            </div>
            <div class="form-group">
    ...
    <!-- /.box -->
    <?php $data['data'] = ['selectDealer'];
    $this->load->view('additionals/dropdown_menu_users', $data); ?>
  </section>
  <script>
