        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID Kabupaten / Kota <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_kabupaten_kota' required value='<?= $row->id_kabupaten_kota ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='kabupaten_kota' required value='<?= $row->kabupaten_kota ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_kabupaten_kota_old', <?= $row->id_kabupaten_kota ?>);
