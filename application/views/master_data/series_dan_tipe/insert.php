          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_tipe" class='form-control' name='kode_tipe'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_warna" class='form-control' name='kode_warna'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_series" class='form-control' name='kode_series'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
