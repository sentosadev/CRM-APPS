        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID Provinsi <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_provinsi' required value='<?= $row->id_provinsi ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='provinsi' required value='<?= $row->provinsi ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
