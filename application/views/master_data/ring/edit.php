        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Ring <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='ring' required value='<?= $row->ring ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_ring', <?= $row->id_ring ?>);
