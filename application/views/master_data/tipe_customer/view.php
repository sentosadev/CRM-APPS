    ...
    <div class="box box-default">
      <div class="box-header with-border">
        ...
        <!-- <div class="box-tools pull-right">
          <a href="h3/part/add">
            <button class="btn bg-blue btn-flat"><i class="fa fa-upload"></i> Upload</button>
          </a>
        </div> -->
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <div class="table-responsive">
          <table class='table table-condensed table-bordered table-striped serverside-tables' style="width:100%">
            <thead>
              <th width='5%'>#</th>
              <th width='15%'>ID Tipe Customer</th>
              <th>Kode Tipe Customer</th>
              <th>Deskripsi Tipe Customer</th>
              <th width="8%">Aktif</th>
              <th width="8%">Aksi</th>
            </thead>
          </table>
