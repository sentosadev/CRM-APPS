        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID Tipe Customer <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" disabled value='<?= $row->id_tipe_customer ?>'>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Kode Tipe Customer <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='kode_tipe_customer' required value='<?= $row->kode_tipe_customer ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Deskripsi Tipe Customer <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='deskripsi_tipe_customer' required value='<?= $row->deskripsi_tipe_customer ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_tipe_customer', <?= $row->id_tipe_customer ?>);
