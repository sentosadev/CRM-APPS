        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Tanggal Libur <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control datepicker" name='tgl_libur' required value='<?= $row->tgl_libur ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
          </div>
