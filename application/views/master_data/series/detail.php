        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID Series <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" disabled value='<?= $row->id_series ?>'>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Kode Series <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='kode_series' required value='<?= $row->kode_series ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Deskripsi Series <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='deskripsi_series' required value='<?= $row->deskripsi_series ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_series', <?= $row->id_series ?>);
