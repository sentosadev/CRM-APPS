          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_kelurahan' required onkeypress="only_number(event)">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_kecamatan" class='form-control' name='id_kecamatan'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
