          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='kode_dealer' required onkeypress="only_number(event)">
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Nama Dealer <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='nama_dealer' required>
                </div>
              </div>
            </div>
