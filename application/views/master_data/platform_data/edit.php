          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_platform_data' value='<?= $row->id_platform_data ?>'>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='platform_data' required value='<?= $row->platform_data ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_platform_data_old', <?= $row->id_platform_data ?>);
