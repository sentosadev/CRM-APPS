        ...
        <form class="form-horizontal" id="form_">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID Kecamatan <span class='required'>*</span></label>
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_kecamatan' required onkeypress="only_number(event)">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_provinsi" class='form-control' name='id_provinsi'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <select id="id_kabupaten_kota" class='form-control' name='id_kabupaten_kota'></select>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <?php $data['data'] = ['selectProvinsi', 'selectKabupatenKota', 'filterKabupatenKotaByIdProvinsi'];
