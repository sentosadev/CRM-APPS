          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='id_kecamatan' required value='<?= $row->id_kecamatan ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name='kecamatan' required value='<?= $row->kecamatan ?>' <?= $disabled ?>>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <script>
    $('#submitButton').click(function() {
      ...
      values.append('id_kecamatan_old', <?= $row->id_kecamatan ?>);
